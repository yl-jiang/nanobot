...
# Github Copilot CLI
python3 {project-directory}/.github/skills/planning-with-files/scripts/session-catchup.py "$(pwd)"
```
...
- Github Copilit CLI: `{project-directory}/.github/skills/planning-with-files/templates`

**Your planning files** go in **your project directory**

| Location | What Goes There |
|----------|-----------------|
| Skill directory (`~/.claude/skills/planning-with-files/` or `~/.codex/skills/planning-with-files/` or `{project-directory}/.github/skills/planning-with-files`) | Templates, scripts, reference docs |
